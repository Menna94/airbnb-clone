            ...
            <div className="col-md-6 offset-md-3">
                ...
                <form >
                   <div className="form-group">
                        <label >price</label>
                        <input type="number"  className="price" id="price" aria-describedby="price"   name="price" value={price}  onChange={setForm}/>
                    </div>
                    <div className="form-group">
                        <label >title</label>
                        <input type="text"  className="price" id="title" aria-describedby="title"   placeholder="title" name="title" value={title}  onChange={setForm}/>
                    </div>
