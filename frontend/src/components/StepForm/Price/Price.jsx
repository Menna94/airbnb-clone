            ...
            <div class="col-md-6 offset-md-3">
                ...
                <form onSubmit = {onSubmit}>
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label >title</label>
                        <input type="text"  class="price" id="title" aria-describedby="title"   placeholder="title" name="title"  min={1} max={1000000} required value={price} value={title}  onChange={setForm}/>
                    </div>
