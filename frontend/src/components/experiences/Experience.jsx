    ...
    <React.Fragment>
      <div className='experience'>
        <div className='container'>
          ...
          <div className="row">
            <div className='col-md-4 col-sm-6 col-8 offset-2 offset-sm-0 mb-3'>
              <div className="card">
                <img src="images/6.jpg" className="card-img-top"></img>
            ...
            <div className='col-md-4 col-sm-6 col-8 offset-2 offset-sm-0 mb-3'>
              <div className="card">
                <img src="images/5.jpg" className="card-img-top"></img>
                <div className="card-body">
                  <h5>Experiences</h5>
            ...
            <div className='col-md-4 col-sm-6 col-8 offset-2 offset-sm-0 mb-3'>
              <div className="card">
                <img src="images/7.jpg" className="card-img-top"></img>
                <div className="card-body">
                  <h5>Adventures</h5>
